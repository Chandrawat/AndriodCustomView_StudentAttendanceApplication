The objective for this assignment is to create an application that receives attendance information (class date & number of students in attendance) from a user and plots the input data on a line graph.
